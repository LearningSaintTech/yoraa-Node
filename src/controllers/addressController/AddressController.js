...
exports.create = async (req, res) => {
  try {
    ...
    const address = new Address({ ...req.body, user: userId }); // Assign userId automatically
    await address.save();
...
exports.deleteById = async (req, res) => {
  try {
    ...
    const deletedAddress = await Address.findOneAndDelete({ _id: id, user: userId }); // Ensure only owner can delete
